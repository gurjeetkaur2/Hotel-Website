...
<body>
  ...
  if (isset($_POST['submit']) and !empty($_POST['submit']) and ($_POST['submit'] == 'Update')) {
    ...
    if ($error == 0 and $id > 0) {
      $query = "UPDATE room SET roomname=?,description=?,roomtype=?,bed=? WHERE roomID=?";
  ...
  $query = 'SELECT roomID,roomname,description,roomtype,bed FROM room WHERE roomid=' . $id;
  ...
  ?>
    ...
    <h2><a href='roomlisting.php'>[Return to the room listing]</a><a href='/assignment2/index.php'>[Return to the main page]</a></h2>

    <form class="form_settings" method="POST" action="editroom.php">
      ...
      <p>
        ...
        <input type="number" id="beds" name="beds" min="1" max="5" value="1" value="<?php echo $row['bed']; ?>" required>
      </p>
