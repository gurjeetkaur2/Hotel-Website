...
<body>
    ...
    <h2><a href='registercustomer.php'>[Create new Customer]</a><a href="/assignment2/index.php">[Return to the main page]</a>
    </h2>
    <form>
        <label for="lname">Lname: </label>
        <input id="lname" type="text" size="30" onkeyup="searchResult(this.value)" onclick="javascript: this.value = ''" placeholder="Start typing a last name">
